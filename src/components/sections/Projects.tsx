...
export function Projects() {
  ...
  const projects = [
    ...
    {
    id: 'churn-prediction',
    titleFR: 'Prédiction de Désabonnement Clients',
    titleEN: 'Customer Churn Prediction',
    subtitleFR: 'Projet de Machine Learning Opérationnel',
    subtitleEN: 'Operational Machine Learning Project',
    descriptionFR: "Conception d'un système de détection précoce des clients à risque via l'analyse de données historiques. Déploiement du modèle dans une application web interactive sous Flask, permettant la visualisation en temps réel des scores de churn et la gestion proactive des risques.",
    descriptionEN: "Design of an early risk detection system for at-risk customers through historical data analysis. Model deployment in an interactive Flask web application, enabling real-time churn score visualization and proactive risk management.",
    techs: ['Python', 'Machine Learning', 'Flask', 'Data Analysis', 'Visualization'],
    demo: '#',
    source: '#',
    hasDemo: false,
    images: ['/projects/churn1.jpeg', '/projects/churn2.jpeg', '/projects/churn3.jpeg'],
    },
    {
      id: 'audio-diffusion',
