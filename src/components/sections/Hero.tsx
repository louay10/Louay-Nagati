      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          ...
          <p className="mt-6 text-gray-300 dark:text-gray-700 text-lg max-w-lg leading-relaxed">
            {language === 'FR'
              ? "Étudiant ingénieur en informatique spécialisé en Data Science et BI/Big Data. Expertise en Machine Learning, LLMs, IA générative et ingénierie des données. À la recherche d'un stage de 4 à 5 mois pour contribuer à des projets innovants."
        ...
        >
          <div className="flex flex-col items-center space-y-6">
            {/* Photo en cercle avec zoom LinkedIn */}
            <div className="relative w-40 h-40 overflow-hidden rounded-full shadow-[0_0_25px_rgba(168,85,247,0.5)] border-4 border-purple-500/30">
              <img
                src="/Louay.jpg"
                alt="Louay Nagati"
            ...
            <div className="text-center">
              ...
              <p className="flex items-center justify-center text-sm text-gray-400 mt-2">
                ...
                {language === 'FR'
                  ? 'Disponible pour un stage de 4 à 5 mois'
            ...
            <div className="flex flex-col items-center space-y-2 text-gray-400 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <span>louaynagati10@gmail.com</span>
              </div>
              <div className="flex items-center space-x-2">
