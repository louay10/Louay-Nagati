...
import { Mail, Phone, MapPin, Linkedin, Github, Download, Send, MessageCircle, User, FileText, Zap, Clock, CheckCircle } from 'lucide-react'
...
export function Contact() {
  ...
  const quickSubjects = language === 'FR' 
    ? [
        { icon: FileText, text: "Projet Data Science", emoji: "📊" },
        { icon: Zap, text: "Opportunité Stage 2026", emoji: "⚡" },
        { icon: MessageCircle, text: "Collaboration IA", emoji: "🤖" },
        { icon: User, text: "Consultation Actuarielle", emoji: "📈" }
      ]
    : [
        { icon: FileText, text: "Data Science Project", emoji: "📊" },
        { icon: Zap, text: "2026 Internship Opportunity", emoji: "⚡" },
        { icon: MessageCircle, text: "AI Collaboration", emoji: "🤖" },
        { icon: User, text: "Actuarial Consultation", emoji: "📈" }
      ]
        ...
        >
          <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full bg-white/10 dark:bg-gray-800/50 backdrop-blur-sm border border-blue-500/30">
            ...
            <span className="text-sm font-medium text-blue-600 dark:text-blue-400">
              {language === 'FR' ? 'Stage disponible Janvier 2026' : 'Internship available January 2026'}
            </span>
          </div>
          
          <h2 className="text-4xl lg:text-6xl font-bold mb-6 text-white dark:text-gray-900">
            {language === 'FR' ? 'Discutons de votre ' : "Let's Discuss Your "}
          ...
          <p className="text-lg lg:text-xl text-gray-300 dark:text-gray-600 max-w-3xl mx-auto leading-relaxed">
            {language === 'FR'
              ? "Prête à transformer vos données en solutions innovantes. Contactez-moi pour discuter de Data Science, IA ou d'Actuariat."
              : "Ready to transform your data into innovative solutions. Contact me to discuss Data Science, AI, or Actuarial Science."}
          </p>
        </div>
          ...
          <div className="lg:col-span-3">
                  ...
                  <div className="space-y-8">
                    <div className="text-center">
                      ...
                      <p className="text-gray-400 dark:text-gray-600">
                        {language === 'FR' 
                          ? 'Sélectionnez un sujet pour démarrer rapidement'
            ...
            <div className="grid grid-cols-3 gap-4 mt-6">
              {[
                ...
                { icon: CheckCircle, value: '100%', labelFR: 'Disponible', labelEN: 'Available', color: 'text-green-400' },
                { icon: MessageCircle, value: 'FR/EN', labelFR: 'Bilingue', labelEN: 'Bilingual', color: 'text-blue-400' }
              ].map((stat, index) => (
                <div 
                  key={index}
