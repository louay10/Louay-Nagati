...
<div className="relative group w-full max-w-[800px] mx-auto rounded-2xl overflow-hidden border border-purple-500/20 shadow-[0_0_25px_rgba(168,85,247,0.15)] bg-gray-900/80 dark:bg-gray-100/80 backdrop-blur-lg">
  <div className="flex items-center justify-center w-full h-[420px] bg-gray-900 dark:bg-gray-100">
    <img
      src={active.images[imgIndex]}
      alt={active.titleEN}
      className="object-contain w-full h-full rounded-2xl transition-transform duration-700 ease-in-out group-hover:scale-[1.01]"
    />
  </div>
