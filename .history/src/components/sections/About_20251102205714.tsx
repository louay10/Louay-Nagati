...
export function About() {
  ...
  return (
    ...
    >
      {/* === Langue + Thème en haut à droite === */}
      <div className="absolute top-6 right-8 flex items-center gap-4 bg-gray-900/50 p-2 rounded-xl border border-gray-700 backdrop-blur-md shadow-lg">
        <button
          onClick={toggleLanguage}
          className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/20 transition text-sm text-gray-200"
        >
          <Globe size={16} />
          <span>{language}</span>
        </button>
