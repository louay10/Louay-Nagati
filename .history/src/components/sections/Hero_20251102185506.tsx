...
<h1 className="text-5xl md:text-6xl font-extrabold leading-tight space-y-2">
  ...
  <span className="inline-block mt-2 px-6 py-2 bg-gradient-to-r from-purple-600/40 to-blue-600/40 border border-blue-400/60 rounded-md shadow-[0_0_15px_rgba(99,102,241,0.5)] backdrop-blur-sm text-white font-semibold tracking-wider">
    ACTUAIRE
  </span>
