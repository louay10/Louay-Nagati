  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-stretch">
        ...
        <div
          className={`bg-gray-900/60 rounded-2xl shadow-lg p-8 backdrop-blur-sm border border-purple-500/10 flex flex-col justify-between h-full ${
        ...
        <div
          className={`bg-gray-900/60 rounded-2xl shadow-lg p-8 backdrop-blur-sm border border-blue-500/10 flex flex-col justify-between h-full ${
