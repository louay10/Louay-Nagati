...
export function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative py-24 px-6 lg:px-12 transition-all duration-700 overflow-hidden 
                 bg-grid dark:bg-grid-dark text-gray-900 dark:text-white"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="flex space-x-4 pt-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-900 
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-900 
                           hover:bg-gradient-to-r hover:from-gray-600 hover:to-gray-400 
                           flex items-center justify-center transition-all shadow"
              >
          ...
          {/* === RIGHT SIDE === */}
          <div className="bg-gray-900/80 dark:bg-white/70 rounded-2xl border border-gray-800 p-8 shadow-xl backdrop-blur-sm transition-all duration-700">
