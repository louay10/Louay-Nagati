  ...
  const projects = [
    {
      ...
      demo: '#',
      source: '#',
      images: ['/projects/ESG.png', '/projects/esg9.jpg', '/projects/esg8.jpg'],
    },
    {
      id: 'actuarialmind',
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <div className="relative group w-full">
            <div className="rounded-2xl overflow-hidden border border-gray-800 dark:border-gray-300 shadow-2xl">
              <img
                src={active.images[imgIndex]}
                alt={active.titleEN}
                className="object-cover w-full h-[420px] transition-transform duration-700 group-hover:scale-[1.02]"
              />
            </div>
