      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            {/* Skills Navigation */}
            <div className={`bg-gray-900/70 dark:bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50 dark:border-gray-300/50 shadow-2xl transition-all duration-700 ${
            ...
            {/* Skills Progress */}
            {currentCategory && (
              <div className={`bg-gray-900/70 dark:bg-white/80 backdrop-blur-xl rounded-2xl p-8 border border-gray-700/50 dark:border-gray-300/50 shadow-2xl transition-all duration-700 ${
                isVisible ? 'animate-slide-in-left animation-delay-300' : 'opacity-0 translate-x-[-50px]'
              }`}>
          ...
          <div className="space-y-8">
            {/* Education */}
            <div className={`bg-gray-900/70 dark:bg-white/80 backdrop-blur-xl rounded-2xl p-8 border border-blue-500/20 shadow-2xl transition-all duration-700 ${
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                  {language === 'FR' ? 'Parcours Académique' : 'Academic Journey'}
                </h3>
              </div>
              ...
              <div className="space-y-6">
                {education.map((edu, index) => (
                  <div 
                    key={index}
                    className="flex gap-4 p-4 rounded-xl bg-gray-800/50 dark:bg-gray-200/50 hover:bg-gray-800/70 dark:hover:bg-gray-200/70 transition-all duration-300 group"
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 text-sm text-gray-400 dark:text-gray-600 mt-1">
            ...
            {/* Certifications */}
            <div className={`bg-gray-900/70 dark:bg-white/80 backdrop-blur-xl rounded-2xl p-8 border border-purple-500/20 shadow-2xl transition-all duration-700 ${
              ...
              <div className="grid gap-4">
                {certifications.map((cert, index) => (
                  <div 
                    key={index}
                    className="flex items-center gap-4 p-4 rounded-xl bg-gray-800/50 dark:bg-gray-200/50 hover:bg-gray-800/70 dark:hover:bg-gray-200/70 transition-all duration-300 group"
                  >
                    <div className={`w-12 h-12 rounded-xl bg-gradient-to-r ${cert.color} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform`}>
