    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-stretch">
          ...
          >
            <div className="bg-gray-900/70 dark:bg-white/80 flex flex-col justify-between min-h-[850px] backdrop-blur-xl rounded-2xl border border-gray-700/50 dark:border-gray-300/50 shadow-2xl p-8">
          ...
          >
            <div className="bg-gray-900/70 dark:bg-white/80 flex flex-col justify-between min-h-[850px] backdrop-blur-xl rounded-2xl border border-blue-500/20 shadow-2xl p-8">
              {/* Education */}
              <div>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  {certifications.map((group, i) => (
                    <div key={i}>
                      ...
                      {group.items.map((cert, j) => (
                        <div
                          key={j}
                          className="flex items-center gap-3 p-3 rounded-xl bg-gray-800/50 hover:bg-gray-800/70 transition-all group"
                        >
                          <div
                            className={`w-8 h-8 rounded-lg bg-gradient-to-r ${group.color} flex items-center justify-center shadow-md group-hover:scale-110 transition-transform`}
                          >
