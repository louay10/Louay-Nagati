    ...
    >
      <div className="max-w-7xl mx-auto px-8 lg:px-16">
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          >
            {/* Main Project */}
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-purple-600/10 group">
              ...
              <div className="w-full h-[340px] md:h-[360px] lg:h-[380px] bg-gray-900 flex items-center justify-center overflow-hidden">
                {active.image ? (
                  <img
                    src={active.image}
                    alt={active.title}
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
              {smallProjects.map((p) => (
                <button
                  ...
                  className={`bg-gray-900/80 rounded-2xl p-4 border border-gray-800 hover:scale-[1.04] transition text-left backdrop-blur-sm ${
                    active.id === p.id ? 'ring-2 ring-purple-500' : ''
                  }`}
                >
                  <div className="h-28 bg-gray-800 rounded-md overflow-hidden flex items-center justify-center">
                    {p.image ? (
                      <img
                        src={p.image}
                        alt={p.title}
