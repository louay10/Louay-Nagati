  ...
  const projects = [
    {
      ...
      demo: '#',
      source: '#',
      images: ['/projects/due-diligence-1.jpg', '/projects/due-diligence-2.jpg'],
    },
    {
      id: 'esg-platform',
      ...
      demo: '#',
      source: '#',
      images: ['/projects/esg-platform-1.jpg', '/projects/esg-platform-2.jpg'],
    },
    {
      id: 'audio-diffusion',
      ...
      demo: '#',
      source: '#',
      images: ['/projects/audio-diffusion-1.jpg', '/projects/audio-diffusion-2.jpg'],
    },
    {
      ...
      demo: '#',
      source: '#',
      images: ['/projects/recruitment-1.jpg', '/projects/recruitment-2.jpg'],
    },
    {
      id: 'real-estate-prediction',
      titleFR: 'Prédiction de Prix Immobiliers',
      titleEN: 'Real Estate Price Prediction',
      subtitleFR: 'Projet Machine Learning End-to-End',
