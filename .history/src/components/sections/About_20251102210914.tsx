...
export function About() {
  ...
  return (
    <section
      id="about"
      ref={ref}
      className="relative py-20 px-6 lg:px-12 transition-all duration-700 min-h-screen flex items-center 
    ...
    >
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-stretch">
        {/* === Partie gauche === */}
        <div
          className={`bg-gray-900/70 dark:bg-white/70 rounded-2xl shadow-lg p-8 backdrop-blur-sm 
