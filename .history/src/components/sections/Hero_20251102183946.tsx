  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        {/* Partie gauche - Photo */}
        <div className="flex flex-col items-center lg:items-start space-y-8 animate-slide-in-left">
        ...
        <div className="space-y-8 text-center lg:text-left animate-slide-in-right animation-delay-300">
