...
export function About() {
  ...
  return (
    <section
      id="about"
      ref={ref}
      className="py-24 px-6 lg:px-12 bg-grid text-white transition-all duration-700"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <div
    className="bg-gray-900/60 rounded-2xl shadow-lg p-8 backdrop-blur-sm transition-all duration-500"
    style={{ minHeight: '550px' }} // 🔹 hauteur fixe
  >
              {activeTab === 'skills' && (
