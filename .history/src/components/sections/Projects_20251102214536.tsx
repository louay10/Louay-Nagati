      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <div className="relative group w-full">
            <div className="relative rounded-2xl overflow-hidden border border-purple-500/20 shadow-[0_0_30px_rgba(168,85,247,0.15)] bg-gradient-to-br from-gray-900/90 to-gray-800/80 dark:from-gray-100 dark:to-gray-200">
              <img
                src={active.images[imgIndex]}
                alt={active.titleEN}
                className="object-cover w-full h-[480px] rounded-2xl transition-transform duration-700 ease-in-out group-hover:scale-[1.03]"
              />
            </div>
