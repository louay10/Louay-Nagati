      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="flex flex-col space-y-8">
            {/* Education Card */}
            <div className={`bg-gray-900/70 dark:bg-white/80 backdrop-blur-xl rounded-2xl border border-blue-500/20 shadow-2xl flex-1 min-h-[400px] transition-all duration-700 ${
            ...
            {/* Certifications Card */}
            <div className={`bg-gray-900/70 dark:bg-white/80 backdrop-blur-xl rounded-2xl border border-purple-500/20 shadow-2xl flex-1 min-h-[400px] transition-all duration-700 ${
              ...
              <div className="p-8 h-full flex flex-col">
                ...
                <div className="grid gap-4 flex-1 overflow-hidden">
                  {certifications.map((cert, index) => (
                    ...
                    >
                      <div className={`w-12 h-12 rounded-xl bg-gradient-to-r ${cert.color} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform flex-shrink-0`}>
