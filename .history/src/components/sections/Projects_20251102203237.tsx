        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-purple-600/10 group">
              ...
              <div className="w-full h-[380px] md:h-[400px] bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
                {active.image ? (
                  <img
                    src={active.image}
                    alt={active.title}
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
              {smallProjects.map((p) => (
                ...
                >
                  <div className="h-28 bg-gray-800 rounded-md overflow-hidden">
                    {p.image ? (
                      <img
                        src={p.image}
                        alt={p.title}
