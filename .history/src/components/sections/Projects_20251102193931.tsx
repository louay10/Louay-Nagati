    ...
    >
      <div className="max-w-7xl mx-auto px-8 lg:px-16">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            {/* Main Project */}
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-purple-600/10">
              ...
              <button
                onClick={prev}
                aria-label="Previous"
                className="absolute left-4 top-1/2 -translate-y-1/2 bg-gray-800/70 p-3 rounded-full hover:bg-gray-700 transition"
              >
              ...
              <button
                onClick={next}
                aria-label="Next"
                className="absolute right-4 top-1/2 -translate-y-1/2 bg-gray-800/70 p-3 rounded-full hover:bg-gray-700 transition"
              >
