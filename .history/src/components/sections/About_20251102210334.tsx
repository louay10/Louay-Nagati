...
export function About() {
  ...
  return (
    <section
      id="about"
      ref={ref}
      className="relative py-20 px-6 lg:px-12 bg-grid text-white transition-all duration-700 min-h-screen flex items-center"
    >
      {/* === Langue + Thème (fixé en haut à droite) === */}
      <div className="absolute top-6 right-6 flex items-center gap-3 z-50">
        <button
          onClick={toggleLanguage}
          className="flex items-center gap-1 bg-gray-800/70 text-white px-3 py-1 rounded-full text-sm hover:bg-gray-700 transition"
        >
      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-stretch">
        {/* === Partie gauche === */}
        <div
          className={`bg-gray-900/60 dark:bg-gray-100/60 text-gray-100 dark:text-gray-900 rounded-2xl shadow-lg p-8 backdrop-blur-sm border border-purple-500/10 flex flex-col justify-between h-full transition-all duration-700 ${
        ...
        {/* === Partie droite === */}
        <div
          className={`bg-gray-900/60 dark:bg-gray-100/60 text-gray-100 dark:text-gray-900 rounded-2xl shadow-lg p-8 backdrop-blur-sm border border-blue-500/10 flex flex-col justify-between h-full transition-all duration-700 ${
