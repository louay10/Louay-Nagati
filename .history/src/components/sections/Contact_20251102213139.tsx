          ...
          >
            ...
            <div className="space-y-5">
              {[ 
                ...
                <div
                  key={i}
                  className="flex items-center gap-4 p-4 bg-gray-100 dark:bg-gray-900/60 rounded-xl border border-gray-200 dark:border-gray-700 backdrop-blur-sm shadow-sm hover:shadow-lg transition"
                >
                  <div
            ...
            <div className="flex space-x-4 pt-4">
              <a
                ...
                className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-800 hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 flex items-center justify-center transition-all shadow"
              >
                <Linkedin className="w-5 h-5 text-gray-700 dark:text-gray-300" />
              </a>
              <a
                href="https://github.com/MaycemSaad"
                className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-800 hover:bg-gradient-to-r hover:from-gray-600 hover:to-gray-400 flex items-center justify-center transition-all shadow"
              >
            ...
            {/* === CV Download === */}
<button className="mt-6 inline-flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full text-sm font-medium text-white shadow hover:brightness-110 transition">
  <a
    href="/public/Mayssem-Saad-CV_versionF.pdf"
    download="Mayssem_Saad_CV.pdf"
  ...
  >
    <svg
      ...
      className="w-4 h-4"
    >
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 16v-8m0 8l-4-4m4 4l4-4m-6 8h8a2 2 0 002-2v-4a2 2 0 00-2-2h-1.5" />
    </svg>
