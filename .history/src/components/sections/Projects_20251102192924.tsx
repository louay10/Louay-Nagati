          ...
          >
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-400">
                <div>- Extraction intelligente de données</div>
                <div>- Analyse sémantique & IA</div>
                <div>- Interface web interactive</div>
                <div>- Architecture modulaire & scalable</div>
              </div>
            </div>
          </div>
          ...
          >
                ...
                {projects.map((_, i) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full ${
                      i === index ? 'bg-white' : 'bg-gray-600/50'
                    }`}
                  />
                ))}
              </div>
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
              {projects.slice(0, 3).map((p) => (
                <div
                  key={p.id}
                  className="bg-gray-900/60 rounded-xl p-4 border border-gray-800 hover:scale-[1.02] transition"
                >
